...
import { signInWithGoogle, signInWithEmail, signUpWithEmail, setUpRecaptcha, signInWithPhone } from "@/lib/firebase";
...
export default function AuthPage() {
  ...
  const handlePhoneAuth = async () => {
    ...
    setLoading(true);
    try {
      // Set up reCAPTCHA verifier if not already done
      if (!recaptchaVerifier) {
        const verifier = setUpRecaptcha("recaptcha-container");
        setRecaptchaVerifier(verifier);
      }

      // Use the existing verifier or the new one
