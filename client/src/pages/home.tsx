          ...
          <div className="text-center mb-16 relative">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:gap-4 justify-center mt-8">
              <Link href="/submit" className="w-full md:w-auto">
                <Button size="lg" className="w-full md:max-w-xs bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-semibold py-3 px-4 md:py-4 md:px-8 text-base md:text-lg shadow-2xl transform transition-all duration-200 hover:scale-110 hover:shadow-purple-500/60 hover:ring-4 hover:ring-purple-400/40 focus:ring-4 focus:ring-purple-400/60 animate-[pulseGlowPurple_2s_infinite]">
                  🚀 ENTER THE CONTEST
                </Button>
              </Link>
