          ...
          <CardContent className="p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div>
                ...
                <div className={`w-16 h-16 bg-yellow-500 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 hover:scale-110 hover:shadow-[0_0_32px_8px_rgba(255,215,0,0.6)] hover:animate-bounce-slow group animate-pulse`}>
                  <Trophy className="text-2xl text-white group-hover:drop-shadow-[0_0_12px_gold] drop-shadow-[0_0_8px_rgba(255,215,0,0.5)]" size={24} />
                </div>
              ...
              <div>
                <div className={`w-16 h-16 bg-gray-400 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 hover:scale-110 hover:shadow-[0_0_32px_8px_rgba(192,192,192,0.6)] hover:animate-bounce-slow group animate-pulse`}>
                  <Medal className="text-2xl text-white group-hover:drop-shadow-[0_0_12px_silver] drop-shadow-[0_0_8px_rgba(192,192,192,0.5)]" size={24} />
                </div>
              ...
              <div>
                <div className={`w-16 h-16 bg-yellow-600 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 hover:scale-110 hover:shadow-[0_0_32px_8px_rgba(255,165,0,0.6)] hover:animate-bounce-slow group animate-pulse`}>
                  <Award className="text-2xl text-white group-hover:drop-shadow-[0_0_12px_orange] drop-shadow-[0_0_8px_rgba(255,165,0,0.5)]" size={24} />
                </div>
