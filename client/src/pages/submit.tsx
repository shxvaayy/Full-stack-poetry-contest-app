          ...
          <div className="text-center mt-8">
            ...
            <Dialog open={showWallDialog} onOpenChange={setShowWallDialog}>
              <DialogTrigger asChild>
                <Button
                  className="mt-6 mb-8 z-10 ring-4 ring-cyan-400 border-2 border-cyan-400 bg-gradient-to-br from-pink-500 via-purple-500 to-pink-400 text-white font-semibold py-4 px-8 text-lg shadow-2xl transform transition-all duration-200 hover:scale-110 hover:shadow-purple-500/60 hover:ring-4 hover:ring-cyan-400/70 focus:ring-4 focus:ring-cyan-400/70 animate-[pulseGlowPurple_2s_infinite] flex items-center gap-2 mx-auto"
