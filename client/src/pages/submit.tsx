              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                ...
                <div className="flex justify-center gap-4">
                  ...
                  <a href="https://www.instagram.com/writoryofficial/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-pink-600 transition-colors">
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                      <rect strokeLinecap="round" strokeLinejoin="round" x="2" y="2" width="20" height="20" rx="5" ry="5"/>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/>
                      <line strokeLinecap="round" strokeLinejoin="round" x1="17.5" y1="6.5" x2="17.51" y2="6.5"/>
                    </svg>
                  </a>
                  <a href="https://www.linkedin.com/company/writoryofficial/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-700 transition-colors">
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                      ...
                      <circle strokeLinecap="round" strokeLinejoin="round" cx="4" cy="4" r="2"/>
                    </svg>
                  </a>
                </div>
              </div>
