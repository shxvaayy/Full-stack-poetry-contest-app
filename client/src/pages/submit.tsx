          ...
          <div className="text-center mt-8">
            ...
            <Dialog open={showWallDialog} onOpenChange={setShowWallDialog}>
              <DialogTrigger asChild>
                <Button
                  className="button-animated-red animate-[pulseGlowRed_2s_infinite] mt-6 mb-8 z-10 bg-gradient-to-br from-pink-500 via-purple-500 to-pink-400 text-white font-semibold py-4 px-8 text-lg shadow-2xl transform transition-all duration-200 hover:scale-110 hover:shadow-red-500/60 flex items-center gap-2 mx-auto"
